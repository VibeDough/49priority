---
name: p3
description: Mark the current or explicitly referenced Codex task P3 normal priority with a green dot in its sidebar title. Use when the user invokes $p3.
---
