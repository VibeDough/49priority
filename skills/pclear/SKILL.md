---
name: pclear
description: Remove a colored priority dot from the current or explicitly referenced Codex task sidebar title. Use when the user invokes $pclear or asks to clear a task priority marker.
---
